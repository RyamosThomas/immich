...
export const setupBaseMockApiRoutes = async (context: BrowserContext, adminUserId: string) => {
  ...
  await context.route('**/server/about', async (route) => {
    return route.fulfill({
      ...
      json: {
        version: 'v2.2.3',
        versionUrl: 'https://github.com/RyamosThomas/immich/releases/tag/v2.2.3',
        licensed: false,
        build: '1234567890',
        buildUrl: 'https://github.com/RyamosThomas/immich/actions/runs/1234567890',
        buildImage: 'e2e',
        buildImageUrl: 'https://github.com/RyamosThomas/immich/pkgs/container/immich-server',
        repository: 'RyamosThomas/immich',
        repositoryUrl: 'https://github.com/RyamosThomas/immich',
        sourceRef: 'e2e',
        sourceCommit: 'e2eeeeeeeeeeeeeeeeee',
        sourceUrl: 'https://github.com/RyamosThomas/immich/commit/e2eeeeeeeeeeeeeeeeee',
        nodejs: 'v22.18.0',
        exiftool: '13.41',
        ffmpeg: '7.1.1-6',
        libvips: '8.17.2',
